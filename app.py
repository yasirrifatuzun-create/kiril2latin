...
st.markdown("""
<style>
/* 1. Harf Butonları: KARE yapı ve içerik tam ORTALI */
div[data-testid="column"] button {
    ...
    /* Metni tam merkezlemek için gerekli flex ayarları */
...
/* 2. İşlem Butonları (Dönüştür, Temizle, Sesle Oku): DİKDÖRTGEN yapı */
